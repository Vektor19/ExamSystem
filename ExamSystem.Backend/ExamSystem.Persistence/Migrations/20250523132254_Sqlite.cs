    ...
    public partial class Sqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExamUserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ExamId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CompleteStatus = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamUsers", x => x.ExamUserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamId = table.Column<Guid>(type: "TEXT", nullable: false),
                    QuestionId = table.Column<Guid>(type: "TEXT", nullable: false),
                    QuestionOptionId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleId", "IsSystem", "Name" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), true, "Admin" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), true, "Student" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), true, "Examinator" }
                });
